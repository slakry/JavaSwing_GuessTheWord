...
public class MainGame extends JFrame {
	...
	private void createGUI() {
		...
		//obrazek jako tlo JFrame
		try {
			mainFrame.setContentPane(new JLabel(new ImageIcon(ImageIO.read(new File("D:\\JAVA_programing\\workspace\\01_gra_odgaywanie_wymieszanych_slowek\\src\\img\\mainFrame_background.png")))));
        } catch (IOException e) {
            e.printStackTrace();
        }
		...
		//RADIO CHECK BOX MENU ITEM
		 ...
		 //TWORZYMY GRUPÊ (dziêki temu bêdzie m¿na wybraæ tylko jedn¹ kategoriê)
	...
	private class StopListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			tfUsersWord.setText("");
			tfRightWord.setText("");
			miEmpty.setSelected(true);			//wybranie Epty który jest w box a nie ma go w menuitem
			buttonClose.setEnabled(false);
		}
	}
